...
int main(int argc, char *argv[]) {
  ...
  bt1.Init("1", "Roboto", "resources/Button.png", renderer, 160, 160);
  bt2.Init("2", "Roboto", "resources/Button.png", renderer, 160, 160);
  bt3.Init("3", "Roboto", "resources/Button.png", renderer, 160, 160);
  bt4.Init("4", "Roboto", "resources/Button.png", renderer, 160, 160);
  bt5.Init("5", "Roboto", "resources/Button.png", renderer, 160, 160);
  bt6.Init("6", "Roboto", "resources/Button.png", renderer, 160, 160);
  bt7.Init("7", "Roboto", "resources/Button.png", renderer, 160, 160);
  bt8.Init("8", "Roboto", "resources/Button.png", renderer, 160, 160);
  bt9.Init("9", "Roboto", "resources/Button.png", renderer, 160, 160);
