...
void aequus::audio::TerminateDevice()
{
	Mix_CloseAudio();
}
...
void aequus::audio::PlayChunk(int loops, int fadein, int time, int chunk, int channel)
{
	Mix_FadeInChannelTimed(channel, chunks[chunk].GetChunk(), loops, fadein, time);
}
