...
void aequus::video::MessageBox::SetColor(MessageBoxColorType type, float red,
...
void aequus::video::MessageBox::AddButton(MessageBoxButtonFlags flags,
                                          std::string text) {
...
int aequus::video::MessageBox::RunMessageBox() {
  if (internalmessageboxdata.buttons.size() <= 0) {
    SDL_ShowSimpleMessageBox(
        internalmessageboxdata.flags, internalmessageboxdata.title.c_str(),
        internalmessageboxdata.message.c_str(), internalmessageboxdata.window);
  } else {
